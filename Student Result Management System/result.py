...
class resultClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Add Student Result Details",font=('times new roman',20,"bold"),bg='orange',fg="#262626").place(x=10,y=15,width=1180,height=50)
    ...
    #============labels================
        ...
        btn_search=Button(self.root,text='Search',font=("times new roman",10,'bold'),bg="#03a9f4",fg='white',cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=28)
        ...
        #============button================
        btn_add=Button(self.root,text="Submit",font=("times new roman",12),bg="lightgreen",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_clear=Button(self.root,text="Clear",font=("times new roman",12),bg="lightgrey",activebackground="lightgrey",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
