...
class RMS:
    def __init__(self,root):
        ...
        btn_student=Button(M_Frame,text="Student",font=("goudy old style",13,"bold"),bg="#0b5377",fg="white",cursor="hand2 ",command=self.add_student).place(x=240,y=5,width=100,height=40)
        ...
        btn_view=Button(M_Frame,text="ViewResult",font=("goudy old style",13,"bold"),bg="#0b5377",fg="white",cursor="hand2",command=self.add_report).place(x=680,y=5,width=100,height=40)
        ...
        btn_exit=Button(M_Frame,text="Exit",font=("goudy old style",13,"bold"),bg="#0b5377",fg="white",cursor="hand2 ",command=self.exit_).place(x=1120,y=5,width=100,height=40)
...
#==================================================================================
    ...
    def exit_(self):
        op=messagebox.askyesno("Confirm","Doyou really want to exit?",parent=self.root)
        if op==True:
            self.root.destroy()
